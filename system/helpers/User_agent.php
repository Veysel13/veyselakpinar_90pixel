...
if ( ! function_exists('get_server_addr')) {
...
if( ! function_exists('get_mobile_type')) {
    function get_mobile_type($control = true)
    {
        include_once SYSURL . "libraries/MobileDetect/Mobile_Detect.php";
        ...
        if($control == true){
            ...
            if( $detect->isiOS() || $detect->isAndroidOS() || $detect->isTablet()){
                return true;
            }
        }
    }
 ...
 */
if( ! function_exists('referer_control')) {
    function referer_control($domain = "")
    {
        if(get_referer() != '') {
            if ( $parts = parse_url( get_referer() ) ) {
                $scheme = $parts[ "scheme" ];
                $host   = $parts[ "host" ];
                if(strstr($scheme . "://" . $host, $domain)) {
                    return true;
                }else{
                    return false;
                }
