...
class ThreeDPaymentCompleteRequest extends  IparaBase
{
    public $ThreeD;
    public $OrderId;
    public $Amount;
    ...
    public static function execute(ThreeDPaymentCompleteRequest $request, IparaSettings $settings)
    {
        ...
        return  restHttpCaller::post("https://api.ipara.com/" . "rest/payment/auth", IparaHelper::GetHttpHeaders($settings, "application/xml"), $request->toXmlString());
    }
