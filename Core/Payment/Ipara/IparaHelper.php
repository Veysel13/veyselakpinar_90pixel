...
class IparaHelper {
    ...
    public static function Validate3DReturn(ThreeDPaymentInitResponse $paymentResponse,IparaSettings $settings)
    ...
    public static function GetHttpHeaders (IparaSettings $settings, $acceptType)

    {
        ...
        $header = array(
            ...
            "token:" . IparaHelper::CreateToken($settings->PublicKey, $settings->HashString),
